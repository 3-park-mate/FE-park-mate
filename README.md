...
| 기능 | 구현 목록 | 설명 |
|:------|:------|:------|
| **지도**   | 주차장 탐색 <br/> 주차장 필터링 <br/> 위치 검색 | 실시간으로 주차장 별 빈자리 수를 확인할 수 있습니다. <br/> 카카오맵 api를 활용했습니다.          |
| **주차장** | 주차장 탐색 <br/> 주차장 필터링                 | 지도 페이지 내에서 주차장을 탐색하고, 일정 및 전기차 충전 여부를 필터링하는 기능을 구현했습니다. |
| **예약**   | 예약 가능 여부 확인 <br/> 예약                  | 일정 선택 후 잔여 주차면 수를 확인하고 예약할 수 있도록 구현하였습니다.                          |
...
| **알림** | 리뷰 작성 | - FCM 및 서비스 워커를 통한 실시간 알림<br>- 알림 발생 시 toast UI로 사용자에게 안내 |
